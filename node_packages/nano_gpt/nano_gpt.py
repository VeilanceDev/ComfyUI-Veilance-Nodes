...
from ...utils.comfy_reflection import seed_input_with_control
from ...utils.http_utils import read_http_error_body, read_url_limited
    ...
    def _generate_with_settings(
        ...
        *,
        ...
        for attempt in range(max_retries):
            try:
                response_body = read_url_limited(
                    req,
                    timeout=30,
